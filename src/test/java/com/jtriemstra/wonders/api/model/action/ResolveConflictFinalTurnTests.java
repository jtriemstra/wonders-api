...
public class ResolveConflictFinalTurnTests extends TestBase {
	...
	public void when_final_turn_resolution_is_correct() {
		...
		Assertions.assertEquals(2,  testPlayer.getArmyFacade().getNumberOfVictories(1));
		Assertions.assertEquals(0,  p2.getArmyFacade().getNumberOfVictories(1));
		Assertions.assertEquals(0,  p3.getArmyFacade().getNumberOfVictories(1));
